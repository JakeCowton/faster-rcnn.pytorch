...
if __name__ == '__main__':
    ...
    elif args.dataset == "pigs_voc":
        args.imdb_name = "pigs_voc_train"
        args.imdbval_name = "pigs_voc_train"
        args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS',
                         '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        save_name = os.path.join(output_dir, 'faster_rcnn_{}_{}_{}.pth'\
                                             .format(args.session, epoch, step))
        save_checkpoint({
          'session': args.session,
          'epoch': epoch + 1,
          'model': fasterRCNN.module.state_dict() if args.mGPUs \
